    ...
    private void initialize() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    String dataDev = textField.getText();
                    Integer valor = Integer.parseInt(textField_1.getText());
                    String cpf = textField_2.getText();
                    String placa = textField_3.getText();

                    Fachada.cadastrarAluguel(dataDev, valor, Fachada.consultarClientesPorCpf(cpf), Fachada.consultarVeiculo(placa));
                    textField.setText("");
                    textField_1.setText("");
                    textField_2.setText("");
                    textField_3.setText("");
